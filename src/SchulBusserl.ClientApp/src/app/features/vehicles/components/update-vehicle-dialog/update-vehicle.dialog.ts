...
import { UpdateVehicleDialogContext, UpdateVehicleDialogStore, UpdateVehicleDialogFormValue } from 'app/features/vehicles/components/update-vehicle-dialog/update-vehicle-dialog.store';
...
export class UpdateVehicleDialogComponent extends FormDialogDirective<UpdateVehicleDialogContext, UpdateVehicleDialogFormValue, InstanceType<typeof UpdateVehicleDialogStore>, UpdateVehicleForm> {
  protected createForm(formBuilder: FormBuilder, initialValue: Partial<UpdateVehicleDialogFormValue>): UpdateVehicleForm {
...
type UpdateVehicleForm = FormGroup<{ name: FormControl<string>; licensePlate: FormControl<string>; numberOfPassengerSeats: FormControl<number>; }>;
